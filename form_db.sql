...
-- Dumping database structure for form_db
CREATE DATABASE IF NOT EXISTS `form_db` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `form_db`;

-- Dumping structure for table form_db.admin
...
-- Dumping data for table form_db.admin: ~7 rows (approximately)
DELETE FROM `admin`;
INSERT INTO `admin` (`id`, `full_name`, `username`, `password`, `position`, `center_name`, `region`, `province`, `city`, `email`, `phone`, `address`, `profile_image`) VALUES
	...
	(29, 'Test', 'Test', 'scrypt:32768:8:1$kQmTZlT5XZImkZfc$82e5e8b73484d6c9491941f9795a5c61a5447c5f552023765b8b986194e0cc0157e74ddc8584b268ffa8f945216c3908e3cca08df9c7f0ab46ccf69b0bbcad40', 'Nurse', 'RHU Mayorga', '08', '0837', '083738', 'test@gmail.com', '09121212121', NULL, NULL);

-- Dumping structure for table form_db.assessment
...
-- Dumping data for table form_db.assessment: ~31 rows (approximately)
...
-- Dumping structure for table form_db.assessment_response
...
-- Dumping data for table form_db.assessment_response: ~617 rows (approximately)
...
-- Dumping structure for table form_db.notification
...
-- Dumping data for table form_db.notification: ~15 rows (approximately)
...
-- Dumping structure for table form_db.questions
...
-- Dumping data for table form_db.questions: ~12 rows (approximately)
...
-- Dumping structure for table form_db.recommendations
...
-- Dumping data for table form_db.recommendations: ~62 rows (approximately)
...
-- Dumping structure for table form_db.referral_history
CREATE TABLE IF NOT EXISTS `referral_history` (
  ...
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`),
  CONSTRAINT `referral_history_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Dumping data for table form_db.referral_history: ~0 rows (approximately)
DELETE FROM `referral_history`;

-- Dumping structure for table form_db.services
...
-- Dumping data for table form_db.services: ~105 rows (approximately)
...
-- Dumping structure for table form_db.signature
CREATE TABLE IF NOT EXISTS `signature` (
  ...
  KEY `user_id` (`user_id`),
  CONSTRAINT `signature_ibfk_1` FOREIGN KEY (`admin_id`) REFERENCES `admin` (`id`),
  CONSTRAINT `signature_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=22 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Dumping data for table form_db.signature: ~11 rows (approximately)
...
-- Dumping structure for table form_db.user
CREATE TABLE IF NOT EXISTS `user` (
  ...
  `assigned_center` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `referral_history` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
  ...
  `last_forwarded_by` varchar(150) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `last_forwarded_by_position` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=147 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Dumping data for table form_db.user: ~28 rows (approximately)
DELETE FROM `user`;
INSERT INTO `user` (`id`, `control_num`, `first_name`, `middle_initial`, `last_name`, `dob`, `age`, `contact`, `sex`, `region`, `province`, `city`, `barangay`, `street`, `is_deleted`, `location`, `date`, `assigned_center`, `referral_history`, `reason`, `submitted_at`, `visible_to_brgy`, `visible_to_rhu`, `visible_to_hospital`, `last_forwarded_by`, `last_forwarded_by_position`) VALUES
	...
	(135, '0860-02-00001', 'Test', 'test', 'test', '2000-10-10', 25, '09121212121', 'Male', '08', '0837', '083738', '083738112', '', 0, 'Gandara AFHF', '2025-10-10', NULL, NULL, NULL, '2025-10-11 02:43:28', 0, 0, 1, NULL, NULL),
	(136, '0837-04-00002', 'Test', 'test', 'test', '1990-10-10', 35, '09121212121', 'Male', '08', '0837', '083738', '083738067', '', 0, 'Abuyog DH AFHF', '2025-10-10', NULL, NULL, NULL, '2025-10-19 02:26:23', 0, 0, 1, NULL, NULL),
	(137, NULL, 'Test', 'test', 'test', '2000-10-10', 25, '09121212121', 'Female', '01', '0128', '012801', '012801001', 'Margen', 0, 'Gandara AFHF', '2025-10-10', NULL, NULL, NULL, '2025-10-25 08:18:48', 1, 1, 1, NULL, NULL),
	(138, NULL, 'Test', 'test', 'test', '1994-12-12', 30, '09121212121', 'Male', '10', '1013', '101313', '101313005', '', 0, 'Abuyog DH AFHF', '2024-12-12', NULL, NULL, NULL, '2025-10-25 18:56:56', 1, 1, 1, NULL, NULL),
	(139, NULL, 'Test', 'test', 'test', '2000-10-10', 25, '09121212121', 'Male', '08', '0837', '083720', '083720016', '', 0, 'Gandara DH AFHF', '2025-10-11', NULL, NULL, NULL, '2025-10-26 14:53:40', 1, 1, 1, NULL, NULL),
	(140, NULL, 'Test', '', 'test', '2000-11-10', 24, '09121212121', 'Female', '13', '1339', '133914', '133914017', '', 0, 'RHU Gandara', '2025-10-10', NULL, NULL, NULL, '2025-10-26 14:54:21', 1, 1, 1, NULL, NULL),
	(141, '0860-02-00002', 'Test', 'test', 'test', '2000-11-11', 24, '09121212121', 'Male', '08', '0837', '083728', '083728018', '', 0, 'Gandara AFHF', '2025-10-25', NULL, NULL, NULL, '2025-10-26 15:36:31', 0, 0, 1, NULL, NULL),
	(142, NULL, 'Test', 'test', 'test', '2003-01-01', 22, '09161823232', 'Female', '13', '1339', '133907', '133907008', '', 0, 'Gandara AFHF', '2025-10-01', NULL, NULL, NULL, '2025-11-01 23:45:34', 1, 1, 1, NULL, NULL),
	(143, NULL, 'Test', 'test', 'test', '2000-01-01', 25, '09161823232', 'Female', '14', '1411', '141111', '141111010', '', 0, 'Abuyog DH AFHF', '2025-10-01', NULL, NULL, NULL, '2025-11-02 00:07:04', 1, 1, 1, NULL, NULL),
	(144, NULL, 'Test', 'test', 'test', '2000-02-01', 25, '09161823232', 'Female', '10', '1018', '101801', '101801011', '', 0, 'RHU Pagsanghan', '2025-10-01', NULL, NULL, NULL, '2025-11-02 00:11:58', 1, 1, 1, NULL, NULL),
	(145, NULL, 'Test', 'test', 'test', '1999-01-11', 26, '09161823232', 'Male', '14', '1481', '148102', '148102012', '', 0, 'Abuyog DH AFHF', '2025-10-01', NULL, NULL, NULL, '2025-11-02 02:19:16', 1, 1, 1, NULL, NULL),
	(146, '0860-03-00001', 'Test', 'test', 'test', '1992-02-02', 33, '09161823232', 'Male', '13', '1376', '137604', '137604014', '', 0, 'RHU Gandara', '2025-10-01', NULL, NULL, NULL, '2025-11-03 06:28:31', 0, 1, 0, NULL, NULL);

-- Dumping structure for table form_db.user_response
...
-- Dumping data for table form_db.user_response: ~261 rows (approximately)
...
INSERT INTO `user_response` (`id`, `user_id`, `question_number`, `response`, `is_read`, `submitted_at`) VALUES
	...
	(464, 135, 1, 'No', 0, '2025-10-11 10:43:36'),
	(465, 135, 2, 'Yes', 0, '2025-10-11 10:43:40'),
	(466, 135, 3, 'No', 0, '2025-10-11 10:43:43'),
	(467, 135, 4, 'Yes', 0, '2025-10-11 10:43:45'),
	(468, 135, 5, 'No', 0, '2025-10-11 10:43:49'),
	(469, 135, 6, 'Yes', 0, '2025-10-11 10:43:51'),
	(470, 135, 7, 'No', 0, '2025-10-11 10:43:54'),
	(471, 135, 8, 'Yes', 0, '2025-10-11 10:43:57'),
	(472, 135, 9, 'No', 0, '2025-10-11 10:44:00'),
	(473, 135, 10, 'Yes', 0, '2025-10-11 10:44:03'),
	(474, 135, 11, 'No', 0, '2025-10-11 10:44:06'),
	(475, 135, 12, 'Yes', 0, '2025-10-11 10:44:09'),
	(476, 135, 0, 'Completed the assessment', 0, '2025-10-11 10:44:54'),
	(477, 136, 1, 'No', 0, '2025-10-19 11:08:17'),
	(478, 136, 2, 'No', 0, '2025-10-19 11:08:22'),
	(479, 136, 3, 'No', 0, '2025-10-19 11:08:27'),
	(480, 136, 4, 'Yes', 0, '2025-10-19 11:08:33'),
	(481, 136, 5, 'No', 0, '2025-10-19 11:08:43'),
	(482, 136, 6, 'No', 0, '2025-10-19 11:08:46'),
	(483, 136, 7, 'No', 0, '2025-10-19 11:08:47'),
	(484, 136, 8, 'Yes', 0, '2025-10-19 11:08:49'),
	(485, 136, 9, 'No', 0, '2025-10-19 11:08:52'),
	(486, 136, 10, 'Yes', 0, '2025-10-19 11:08:53'),
	(487, 136, 11, 'No', 0, '2025-10-19 11:08:55'),
	(488, 136, 12, 'Yes', 0, '2025-10-19 11:08:56'),
	(489, 136, 0, 'Completed the assessment', 0, '2025-10-19 11:08:58'),
	(490, 138, 1, 'No', 0, '2025-10-26 03:57:02'),
	(491, 138, 2, 'No', 0, '2025-10-26 03:57:09'),
	(492, 138, 3, 'No', 0, '2025-10-26 03:57:13'),
	(493, 138, 4, 'No', 0, '2025-10-26 03:57:17'),
	(494, 141, 1, 'No', 0, '2025-10-27 18:47:40'),
	(495, 141, 2, 'No', 0, '2025-10-27 18:47:43'),
	(496, 141, 3, 'Yes', 0, '2025-10-27 19:57:51'),
	(497, 141, 4, 'Yes', 0, '2025-10-27 19:57:54'),
	(498, 141, 5, 'Yes', 0, '2025-10-27 19:57:55'),
	(499, 141, 6, 'Yes', 0, '2025-10-27 19:57:57'),
	(500, 141, 7, 'Yes', 0, '2025-10-27 19:57:59'),
	(501, 141, 8, 'Yes', 0, '2025-10-27 19:58:00'),
	(502, 141, 9, 'Yes', 0, '2025-10-27 19:58:02'),
	(503, 141, 10, 'Yes', 0, '2025-10-27 19:58:04'),
	(504, 141, 11, 'Yes', 0, '2025-10-27 19:58:06'),
	(505, 141, 12, 'Yes', 0, '2025-10-27 19:58:08'),
	(506, 141, 0, 'Completed the assessment', 0, '2025-10-27 19:58:13'),
	(507, 142, 1, 'Yes', 0, '2025-11-02 08:06:18'),
	(508, 142, 2, 'Yes', 0, '2025-11-02 08:06:21'),
	(509, 142, 3, 'Yes', 0, '2025-11-02 08:06:23'),
	(510, 142, 4, 'Yes', 0, '2025-11-02 08:06:27'),
	(511, 142, 5, 'Yes', 0, '2025-11-02 08:06:28'),
	(512, 143, 1, 'Yes', 0, '2025-11-02 08:09:57'),
	(513, 144, 1, 'Yes', 0, '2025-11-02 10:16:15'),
	(514, 144, 2, 'Yes', 0, '2025-11-02 10:18:02'),
	(515, 145, 1, 'Yes', 0, '2025-11-02 10:20:55'),
	(516, 145, 2, 'Yes', 0, '2025-11-03 12:22:23'),
	(517, 145, 3, 'Yes', 0, '2025-11-03 12:22:26'),
	(518, 145, 4, 'Yes', 0, '2025-11-03 12:22:27'),
	(519, 145, 5, 'Yes', 0, '2025-11-03 12:22:29'),
	(520, 145, 6, 'Yes', 0, '2025-11-03 12:22:31'),
	(521, 145, 7, 'Yes', 0, '2025-11-03 12:22:32'),
	(522, 145, 8, 'Yes', 0, '2025-11-03 12:22:33'),
	(523, 145, 9, 'Yes', 0, '2025-11-03 12:28:51'),
	(524, 145, 10, 'Yes', 0, '2025-11-03 12:28:52'),
	(525, 145, 11, 'Yes', 0, '2025-11-03 12:28:54'),
	(526, 145, 12, 'Yes', 0, '2025-11-03 12:28:56'),
	(527, 146, 1, 'Yes', 0, '2025-11-03 14:28:33'),
	(528, 146, 2, 'Yes', 0, '2025-11-03 14:28:43'),
	(529, 146, 3, 'Yes', 0, '2025-11-03 14:28:45'),
	(530, 146, 4, 'Yes', 0, '2025-11-03 14:28:47'),
	(531, 146, 5, 'Yes', 0, '2025-11-03 14:28:48'),
	(532, 146, 6, 'Yes', 0, '2025-11-03 14:28:49'),
	(533, 146, 7, 'Yes', 0, '2025-11-03 14:28:51'),
	(534, 146, 8, 'Yes', 0, '2025-11-03 14:29:04'),
	(535, 146, 9, 'Yes', 0, '2025-11-03 14:29:06'),
	(536, 146, 10, 'Yes', 0, '2025-11-03 14:29:08'),
	(537, 146, 11, 'Yes', 0, '2025-11-03 14:29:09'),
	(538, 146, 12, 'Yes', 0, '2025-11-03 14:29:10'),
	(539, 146, 0, 'Completed the assessment', 0, '2025-11-03 14:29:12'),
	(540, 146, 0, 'Completed the assessment', 0, '2025-11-03 15:11:25');
